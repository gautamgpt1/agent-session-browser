...
- It reads local coding-agent history and writes a local SQLite index and exports.
...
- Its index and exports can contain the same sensitive material as source sessions.
